...
public class Address extends AppCompatActivity {
    EditText door, street, pincode;
    Spinner city, state;
    TextView skipbtn;
    Button submitbtn;
    String statedropdown,districtdropdown;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                city = findViewById(R.id.city);
                statedropdown = state.getSelectedItem().toString();

                int parentID = parent.getId();
                if(parentID == R.id.state);{
                    switch (statedropdown){
                    ...
                    city.setAdapter(districtAdapter);

                    city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            districtdropdown = city.getSelectedItem().toString();
                        }
        ...
        skipbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Address.this,LoginPage.class);
        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String doorno = door.getText().toString();
                ...
                String pincde = pincode.getText().toString();
                AddressList addressList = new AddressList(doorno,streetname, cityname, statename, pincde);
                databaseReference.child("USERS").child("USER ADDRESS").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(addressList);
                Intent i = new Intent(Address.this,LoginPage.class);
                startActivity(i);
            }
        });
    }
